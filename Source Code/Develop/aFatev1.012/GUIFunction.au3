...
;~ Lập giá trị cho $CurHPL
Func CurHPL_Get()
	Return GUICtrlRead($CurHPL)
EndFunc
;~ Lấy giá trị từ $CurHPL
Func CurHPL_Set($NewValue = "")
	Local $Check = CurHPL_Get()
	If $Check <> $NewValue Then GUICtrlSetData($CurHPL,$NewValue)
EndFunc		
	
	
;~ Lập giá trị cho MaxHPL
Func MaxHPL_Get()
	Return GUICtrlRead($MaxHPL)
EndFunc
;~ Lấy giá trị từ MaxHPL
Func MaxHPL_Set($NewValue = "")
	Local $Check = MaxHPL_Get()
	If $Check <> $NewValue Then GUICtrlSetData($MaxHPL,$NewValue)
EndFunc			
