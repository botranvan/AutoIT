...
;~ 	If Not WinActive($GameTitle) And Not $Start Then Run("winmine")	;Kích hoạt game
	Start_Button_Toogle()
EndFunc
...
Func Game_Scan_Mine($x,$y)
	...
	Local $Mine_Number = Mine_Get_Number($Cur_Mine)

	MouseMove($Cur_Mine[0],$Cur_Mine[1])
;~ 	tooltip($Mine_Number,$Cur_Mine[0],$Cur_Mine[1])
EndFunc
