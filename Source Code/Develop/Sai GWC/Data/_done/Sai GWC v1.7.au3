...
Func UpLoadNewGet()
	Execute("UpLoad"&$ListWebSite[$WebID][1]&"()")
...
Func SaveContent4($LN,$ConfigFile="")
	...
	IniWrite($ConfigFile,$LN,"$probidmon",$probidmon)
	IniWrite($ConfigFile,$LN,"$probidday",$probidday)
	IniWrite($ConfigFile,$LN,"$probidyear",$probidyear)
