...
#include "constantsArray.au3"
; ---
#include "Bass_dll.au3"

Func _BASS_ErrorGetText()
	Return _value2constant(_BASS_ErrorGetCode())
EndFunc

Func _value2constant($val)
	For $i = 1 To $_BASS_ConstantsArray[0][0]
		If $_BASS_ConstantsArray[$i][1] = $val Then Return $_BASS_ConstantsArray[$i][0]
	Next
	Return SetError(1, 'No match', $val)
EndFunc
