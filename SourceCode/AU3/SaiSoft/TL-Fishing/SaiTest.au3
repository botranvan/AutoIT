...
Func DShowTest()
	...
	$Text&= "$Fishing: "&$Fishing&@CRLF
	$Text&= "$IsFishing: "&$IsFishing&@CRLF
	$Text&= "$IsCaught: "&$IsCaught&@CRLF
	$Text&= "$FishingHolePos: "&$FishingHolePos[0]&":"&$FishingHolePos[1]&@CRLF
	$Text&= "$HookPos: "&$HookPos[0]&":"&$HookPos[1]&@CRLF
