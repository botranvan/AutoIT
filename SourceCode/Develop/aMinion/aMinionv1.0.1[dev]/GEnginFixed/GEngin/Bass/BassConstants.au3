...
; ===============================================================================================================================
Global Const $DSCCAPS_EMULDRIVER = 32	; $DSCAPS_EMULDRIVER device does NOT have hardware DirectSound recording support
Global Const $DSCCAPS_CERTIFIED = 64	; $DSCAPS_CERTIFIED device driver has been certified by Microsoft
...
Global Const $BASS_MP3_SETPOS = 0x20000		 ; $BASS_STREAM_PRESCAN
...
Global Const $BASS_MUSIC_FLOAT = 256  ; $BASS_SAMPLE_FLOAT
Global Const $BASS_MUSIC_MONO = 2 ; $BASS_SAMPLE_MONO
Global Const $BASS_MUSIC_LOOP = 4 ; $BASS_SAMPLE_LOOP
Global Const $BASS_MUSIC_3D = 8 ; $BASS_SAMPLE_3D
Global Const $BASS_MUSIC_FX = 128 ; $BASS_SAMPLE_FX
Global Const $BASS_MUSIC_AUTOFREE = 0x40000 ; $BASS_STREAM_AUTOFREE
Global Const $BASS_MUSIC_DECODE = 0x200000 ; $BASS_STREAM_DECODE
Global Const $BASS_MUSIC_PRESCAN = 0x20000	; $BASS_STREAM_PRESCAN ; calculate playback length
Global Const $BASS_MUSIC_CALCLEN = 0x20000 ; $BASS_MUSIC_PRESCAN
...
Global Const $BASS_SPEAKER_FRONTLEFT = 0x1000000 + 0x10000000 ; $BASS_SPEAKER_FRONT + $BASS_SPEAKER_LEFT
Global Const $BASS_SPEAKER_FRONTRIGHT = 0x1000000 + 0x20000000 ; $BASS_SPEAKER_FRONT + $BASS_SPEAKER_RIGHT
Global Const $BASS_SPEAKER_REARLEFT = 0x2000000 + 0x10000000 ; $BASS_SPEAKER_REAR + $BASS_SPEAKER_LEFT
Global Const $BASS_SPEAKER_REARRIGHT = 0x2000000 + 0x20000000 ; $BASS_SPEAKER_REAR + $BASS_SPEAKER_RIGHT
Global Const $BASS_SPEAKER_CENTER = 0x3000000 + 0x10000000 ; $BASS_SPEAKER_CENLFE + $BASS_SPEAKER_LEFT
Global Const $BASS_SPEAKER_LFE = 0x3000000 + 0x20000000 ; $BASS_SPEAKER_CENLFE + $BASS_SPEAKER_RIGHT
Global Const $BASS_SPEAKER_REAR2LEFT = 0x4000000 + 0x10000000 ; $BASS_SPEAKER_REAR2 + $BASS_SPEAKER_LEFT
Global Const $BASS_SPEAKER_REAR2RIGHT = 0x4000000 + 0x20000000 ; $BASS_SPEAKER_REAR2 + $BASS_SPEAKER_RIGHT
...
Global Const $BASS_FILEPOS_DECODE = 0 ; $BASS_FILEPOS_CURRENT
