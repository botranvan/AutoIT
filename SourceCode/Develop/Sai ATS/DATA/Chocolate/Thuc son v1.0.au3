...
Dim $BasePet =0x005F3544,$Hp_Pet_Curren,$Hp_Pet_Max,$Hp_Pet_Check,$Hp_Pet_Danger
...
Func Hp_Pet_Max() 
	...
	$Hp_Pet_Max = _MemoryRead($Hp_Pet_Max+ 0x3C,$MEMID)
	$Hp_Pet_Max = _MemoryRead($Hp_Pet_Max+ 0x47C,$MEMID)
	Return $Hp_Pet_Max
EndFunc	
Func Hp_Curren() 
    $Hp_Curren = _MemoryRead($BaseAdd ,$MEMID)	
	$Hp_Curren = _MemoryRead($Hp_Curren+0x3c ,$MEMID)
	$Hp_Curren = _MemoryRead($Hp_Curren+ 0x26CF0,$MEMID)
	Return $Hp_Curren
EndFunc	
Func Hp_Max() 
