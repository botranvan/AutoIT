...
Func SaveTemp($FileName = "",$TContent="")
	...
	Local $File = FileOpen($FileName,2+8+32)
...
;~ Biến Mô Tả Chương Trình
	...
	Global $AutoVersion="2.3"						;Phiên Bản
...
;~ 	Local $SessionIEHTML = _IEBodyReadText($SessionIE)
	SaveTemp("SessionIE")
	Local $FileSessionIE = FileOpen("SessionIE",0)
