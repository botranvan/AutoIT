...
Global $ArrayNewGet					;Danh sách nhưng thông tin vừa lấy được
...
;~ 	Nơi hiển thị kết quả vừa lấy được
	...
	Global $NewGet_Lable_Pos[2]=[$Vertically,$Horizontally*2+$TotalURL_Input_Pos[1]+$TotalURL_Input_Size[1]]
...
;~ Biến Mô Tả Chương Trình
	...
	Global $AutoVersion="1.3"						;Phiên Bản
...
;~ Biến ngôn ngữ
	...
	Global $NewGet_Button_Tip="Tải nhưng thông tin vừa lấy được lên WebSite"
	...
	Global $ShowContent_CheckBox_Tip="Ẩn/Hiện nội dung lấy được từ WebSite xuống"
...
Func SaveContent($LN,$ConfigFile="")
	...
	$array = IniReadSectionNames($ConfigFile)
	GUICtrlSetData($Warning_Lable,"Đã lấy được "&$array[0]&" Contractors ")
	GUICtrlSetTip($Warning_Lable,"Đã lấy được "&$array[0]&" Contractors từ "&$ListWebSite[$WebID][2])
EndFunc
...
Func UpLoadNewGet()
	...
	msgbox(0,"Contractor","Đã sẵn sàng tải lên")
EndFunc
